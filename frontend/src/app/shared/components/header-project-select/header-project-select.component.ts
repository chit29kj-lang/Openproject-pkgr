...
import { ChangeDetectionStrategy, Component, HostBinding, OnDestroy, OnInit, ViewEncapsulation, inject } from '@angular/core';
...
export class OpHeaderProjectSelectComponent extends UntilDestroyedMixin implements OnInit, OnDestroy {
  ...
  private searchableProjectListService = inject(SearchableProjectListService);
